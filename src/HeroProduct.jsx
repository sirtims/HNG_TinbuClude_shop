         ...
         <div className={Style.hero_wrapper}>
            <div className={Style.hero_images}>
               <div className={Style.image1}>
                  < img src="header_img\header-img1.png" alt="product 1" />

               </div>
               <div className={Style.big}>
                  < img src="header_img\header_img_big.png" alt="product 1" />

               </div>
               <div className={Style.image3}>
                  < img src="header_img\header-img2.png" alt="product 1" />
            ...
            <main className={Style.hero_wrapper_main}>
               ...
               <section className="newArival">
                  <article>
                     <img src="imag1.png" alt="olive nature" />
                  ...
                  <article>
                     <img src="image2.png" alt="olive nature" />
                     <div className="content">
                  ...
                  <article>
                     <img src="image3.png" alt="olive nature" />
                     <div className="content">
                        <h4>OLIVE NATURE</h4>
                        <p>  tempus vel Morbi sapien venenatis</p>
                        <h6>120 Ml</h6>
